...
bn_out = None
onnxlib._early_exit(fx, 'native_batch_norm_backward')
...
#             new_node = fx.graph.output([bn_out]+[node.args]+[None]*20)
#         break
# fx.graph.lint()
# fx.recompile()
...
#onnxlib._early_exit(fx, 'batch_norm')
#print(fx)
out = fx(sd_grad_vals, sd_nongrad_vals, x)
#print(out[0][0].shape)
print('....')
for o in out[0][1]:
    print( getattr(o, 'shape', o) )
dx3,dw3,db3 = out[0][0]
